...
const reminders = [
  "قال رسول الله (صلى الله عليه واله وسلم): ان لكل شيء دعامة ودعامة هذا الدين الفقه",
  "قال الامام الصادق (عليه السلام): المؤمن اخو المؤمن",
  "قال امير المؤمنين (عليه السلام) : مجالسة الاشرار تورث سوء الظنّ بالاخيار"
];
